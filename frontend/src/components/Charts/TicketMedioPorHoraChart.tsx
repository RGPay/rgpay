...
const TicketMedioPorHoraChart: React.FC<TicketMedioPorHoraChartProps> = ({
  ...
  const getOptions = () => {
    const maxValue = Math.max(...ticketMedioPorHora.map((item) => item.value));
    ...
    return {
          ...
          return `<div style="padding: 12px;">
            ...
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <span style="color: ${theme.palette.text.secondary};">
                Ticket Médio: <strong style="color: ${
                  theme.palette.text.primary
            ...
            <div style="margin-top: 4px; font-size: 12px; color: ${
              ...
              ${percentage}% do maior ticket médio
            </div>
          </div>`;
        },
      ...
      xAxis: {
        type: "category",
        data: ticketMedioPorHora.map((item) => `${item.hour}h`),
        name: "Horário",
        nameLocation: "middle",
        nameGap: 30,
        nameTextStyle: {
      ...
      series: [
        {
          data: ticketMedioPorHora.map((item) => ({
            value: item.value,
            itemStyle: {
              color: {
                type: "linear",
              ...
              shadowColor: alpha(theme.palette.secondary.main, 0.3),
              shadowBlur: 6,
              shadowOffsetY: 3,
            },
          })),
